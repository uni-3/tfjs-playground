...
function* fetchResult(action) {
  try {
    ...
    const res = yield call(postBookApi, stateFormValue)
...
/*
export default {
  runSearchEvery: runSearchEvery,
  runTakeEvery: runTakeEvery
}
*/
